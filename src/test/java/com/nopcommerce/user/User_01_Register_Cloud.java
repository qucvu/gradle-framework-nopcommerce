...
public class User_01_Register_Cloud extends BaseTest {

    @Parameters({"browser", "osName", "osVersion", "browserVersion"})
    @BeforeClass
    public void beforeClass(String browserName, String osName, String osVersion, String browserVersion) {
        ...
        driver = getBrowserDriverLamDaTest(browserName, environment.endUserUrl(), osName, osVersion, browserVersion);
